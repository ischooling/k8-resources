function validateRequestForAddStudent(formId){
	...
	if ($("#"+formId+" #studentFirstName").val()=='' || $("#"+formId+" #studentFirstName").val()==null) {
		showMessage(false, 'Student Name is required');
		return false
	}
	if ($("#"+formId+" #studentLastName").val()=='' || $("#"+formId+" #studentLastName").val()==null) {
		showMessage(false, 'Student Last Name is required');
		return false
	}
	if ($("#"+formId+" #fatherFirstName").val()=='' || $("#"+formId+" #fatherFirstName").val()==null) {
		showMessage(false, 'Father Name is required');
		return false
	}
	if ($("#"+formId+" #fatherLastName").val()=='' || $("#"+formId+" #fatherLastName").val()==null) {
		showMessage(false, 'Father Last Name is required');
		return false
	}
	if ($("#"+formId+" #motherFirstName").val()=='' || $("#"+formId+" #motherFirstName").val()==null) {
		showMessage(false, 'Mother Name is required');
		return false
	}
	if ($("#"+formId+" #motherLastName").val()=='' || $("#"+formId+" #motherLastName").val()==null) {
		...
		success : function(htmlContent) {
			if(htmlContent!=""){
            	...
            	if(stringMessage[0] == "FAILED" || stringMessage[0] == "EXCEPTION" || stringMessage[0] == "SESSIONOUT" ){
        			...
        			var dashboardFor=$('#dashboardFor').val();
...
function getRequestForAddStudentDetails(formId){
	...
	addStudentListDTO['id'] = $("#studentId").val();
	addStudentListDTO['schoolId'] = $("#schoolId").val();
	addStudentListDTO['studentFirstName'] = escapeCharacters($("#"+formId+" #studentFirstName").val());
	addStudentListDTO['studentMiddleName'] = escapeCharacters($("#"+formId+" #studentMiddleName").val());
	addStudentListDTO['studentLastName'] = escapeCharacters($("#"+formId+" #studentLastName").val());
	addStudentListDTO['fatherFirstName'] = escapeCharacters($("#"+formId+" #fatherFirstName").val());
	addStudentListDTO['fatherMiddleName'] = escapeCharacters($("#"+formId+" #fatherMiddleName").val());
	addStudentListDTO['fatherLastName'] = escapeCharacters($("#"+formId+" #fatherLastName").val());
	addStudentListDTO['motherFirstName'] = escapeCharacters($("#"+formId+" #motherFirstName").val());
	addStudentListDTO['motherMiddleName'] = escapeCharacters($("#"+formId+" #motherMiddleName").val());
	addStudentListDTO['motherLastName'] = escapeCharacters($("#"+formId+" #motherLastName").val());
	addStudentListDTO['gender'] = $("#"+formId+" #gender").val();
	...
	addStudentListDTO['currentGrade'] = $("#"+formId+" #currentGrade").val();
...
//	}
	...
	addStudentListDTO['dob'] = $("#"+formId+" #dob").val();
	addStudentListDTO['disablity']=$("input[name='isDisablity']:checked"). val();
	addStudentListDTO['disablityType'] = escapeCharacters($("#"+formId+" #disablityType").val());
	addStudentListDTO['isFromSameSchool'] = $("input[name='isFromSameSchool']:checked"). val();
	
	//addStudentListDTO['courseType'] = $("#"+formId+" #courseType").val();
//	addStudentListDTO['paymentStatus'] = $("#"+formId+" #paymentStatus").val();
...
function calculatePreviousMarks(){
	...
	$("#tbl_gen_marks_pre tbody tr").each(function() {
		var prevMarksDTO = {};
		if($(this).find("select.subjectId option:selected").val()>0){
			prevMarksDTO['practicalMarks'] = $(this).find("input.e_p_marks").val();
			prevMarksDTO['theoryMarks'] = $(this).find("input.e_t_marks").val();
			prevMarksDTO['marksCount'] = $(this).find("span.marks-count").text();
			prevMarksDTO['subjectId'] = $(this).find("select.subjectId option:selected").val();
			...
			prevMarksDTO['cumulativeGrade'] = escapeCharacters($(this).find("input.credit").val());
