function callDashboardPageSchool(moduleId, pageNo, replaceDiv, extraParam){
	...
	if(pageNo=='home'){
		callForDashboardData('formIdIfAny','school-admin-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','create-user-content?moduleId='+moduleId, replaceDiv);
	}else if(pageNo=='user-list'){
		callForDashboardData('formIdIfAny','user-list?moduleId='+moduleId+'&profileFor=common');
	}else if(pageNo=='student-list'){
			callForDashboardData('form','manage-profile-content?moduleId='+moduleId+'&profileFor=student&userClickFrom=list&registrationType=ONE_TO_ONE', replaceDiv);
			$("#studentTab").show();
    		$("#teacherTab").hide();
    		$("#parentsTab").show();
    		$("#flexStudentTab").hide();
			...
			callForDashboardData('form','manage-profile-content?moduleId='+moduleId+'&profileFor=teacher&userClickFrom=list&registrationType=ONE_TO_ONE', replaceDiv);
				$("#studentTab").hide();
		    	$("#teacherTab").show();
		    	$("#parentsTab").hide();
		    	$("#flexStudentTab").hide();
		...
		callForDashboardData('form','manage-profile-content?moduleId='+moduleId+'&profileFor=parent&userClickFrom=list&registrationType=ONE_TO_ONE', replaceDiv);
		...
		callForDashboardData('form','manage-profile-content?moduleId='+moduleId+'&profileFor=school&userClickFrom=list&registrationType=ONE_TO_ONE', replaceDiv);
		window.setTimeout(function(){
				$("#studentTab").hide();
		    	$("#teacherTab").hide();
		    	$("#parentsTab").hide();
		...
		callForDashboardData('form','manage-profile-content?moduleId='+moduleId+'&profileFor=flexStudent&userClickFrom=list&registrationType=ONE_TO_ONE', replaceDiv);
		window.setTimeout(function(){
				$("#studentTab").hide();
		    	$("#teacherTab").hide();
		    	$("#parentsTab").hide();
		...
		callForDashboardData('formIdIfAny','online-users-request-content?moduleId='+moduleId);
	}else if(pageNo=='5a'){
		callForDashboardData('formIdIfAny','teacher-salary-content');
	}else if(pageNo=='teacher-profile'){
		callForDashboardData('formIdIfAny','teacher-profile-request-content?moduleId='+moduleId+'&ids=13&types=0,1');
	}else if(pageNo=='pending-interview-remarks'){
		callForDashboardData('formIdIfAny','teacher-profile-request-interview-content?moduleId='+moduleId+'&ids=19&types=0,1');
//		callForDashboardData('formIdIfAny','teacher-profile-request-content?ids=19&types=0,1');
	}else if(pageNo=='pending-training-remarks'){
		callForDashboardData('formIdIfAny','teacher-profile-request-content?moduleId='+moduleId+'&ids=16&types=0,1');
	}else if(pageNo=='5e'){
		callForDashboardData('formIdIfAny','teacher-profile-request-content?moduleId='+moduleId+'&ids=0,14,16,17,19,20&types=0,1');
	}else if(pageNo=='approved-teachers'){
		callForDashboardData('formIdIfAny','teacher-profile-approved-request-content?moduleId='+moduleId+'&ids=0,14,16,17,19,20&types=0,1');
	}else if(pageNo=='rejected-teachers'){
		callForDashboardData('formIdIfAny','teacher-profile-request-content?moduleId='+moduleId+'&ids=15,18,21&types=2');
	}else if(pageNo=='6a'){
		callForDashboardData('formIdIfAny','teacher-profile-request-content?moduleId='+moduleId+'&ids=1&types=2');
	}else if(pageNo=='manage-school-list'){
		callForDashboardData('formIdIfAny','school-profile-request-content?moduleId='+moduleId);
	}else if(pageNo=='6c'){
		callForDashboardData('formIdIfAny','school-list-request-content');
	}else if(pageNo=='rejected-school'){
		callForDashboardData('formIdIfAny','rejected-school-profile-content?moduleId='+moduleId);
	}else if(pageNo=='review-school-payment'){
		callForDashboardData('formIdIfAny','review-school-payment-content?moduleId='+moduleId);
	}else if(pageNo=='6f'){
		callForDashboardData('formIdIfAny','school-date-of-visit-content?visitSubmitted=');
	}else if(pageNo=='6g'){
		callForDashboardData('formIdIfAny','school-visit-travel-content');
	}else if(pageNo=='evaluation-form'){
		callForDashboardData('formIdIfAny','school-evaluation-form-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','current-syllabus-request-content?moduleId='+moduleId+'&controlType=add');
	}else if(pageNo=='8b'){
		...
		callForDashboardData('formIdIfAny','inquiry-request-content?moduleId='+moduleId);
	}else if(pageNo=='14'){
		callForDashboardData('formIdIfAny','school-teacher-question-content');
	}else if(pageNo=='teacher-interview-slot'){
		callForDashboardData('formIdIfAny','meeting-slots-request-content?moduleId='+moduleId);
	}else if(pageNo=='scholarship'){
		callForDashboardData('formIdIfAny','scholarship-request-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','conflicted-user-content?moduleId='+moduleId);
	}else if(pageNo=='manage-slots'){
		callForDashboardData('formIdIfAny','school-enabled-date-content?moduleId='+moduleId+'&startDate=&endDate=');
	}else if(pageNo=='18b'){
		callForDashboardData('formIdIfAny','school-enabled-date-submit-content?moduleId='+moduleId);
	}else if(pageNo=='delete-user'){
		callForDashboardData('formIdIfAny','delete-user-content?moduleId='+moduleId+'&emailId=');
	}else if(pageNo=='maintenance-down-message'){
		callForDashboardData('formIdIfAny','maintenance-down-message?moduleId='+moduleId);
	}else if(pageNo=='20'){
		callForDashboardData('formIdIfAny','lms-user-content');
	}else if(pageNo=='manage-course'){
		callForDashboardData('formIdIfAny','manage-subjects-content?moduleId='+moduleId);
	}else if(pageNo=='manage-students'){
		callForDashboardData('formIdIfAny','choose-school-content?moduleId='+moduleId+'&schoolId=');
	}else if(pageNo=='21a'){
		callForDashboardData('formIdIfAny','school-list-content?moduleId='+moduleId,replaceDiv);
	}else if(pageNo=='21b'){
		callForDashboardData('formIdIfAny','school-student-list?moduleId='+moduleId+'&controlType=4'+extraParam,replaceDiv);
	}else if(pageNo=='21c'){
		callForDashboardData('formIdIfAny','school-student-list?moduleId='+moduleId+'&controlType=5'+extraParam,replaceDiv);
	}else if(pageNo=='school-student-list'){
		callForDashboardData('formIdIfAny','student-list-content?moduleId='+moduleId+'&controlType=1'+extraParam,replaceDiv);
	}else if(pageNo=='req-subjects'){
		callForDashboardData('formIdIfAny','getSchoolListFor-ReqSubjects-content?moduleId='+moduleId,replaceDiv);
	}else if(pageNo=='all-subjects'){
		callForDashboardData('formIdIfAny','getSchoolListFor-AllSubjects-content?moduleId='+moduleId,replaceDiv);
	}else if(pageNo=='24'){
		...
		callForDashboardData('formIdIfAny','show-Student-not-lms-List?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','manage-course-provider-content?moduleId='+moduleId);
	}else if(pageNo=='manage-categories'){
		callForDashboardData('formIdIfAny','manage-course-content?moduleId='+moduleId);
	}else if(pageNo=='manage-courses'){
		callForDashboardData('formIdIfAny','manage-subject-content?moduleId='+moduleId);
//	}else if(pageNo=='30'){
...
//		callForDashboardData('formIdIfAny','current-placement-syllabus-request-content');
		...
		callForDashboardData('formIdIfAny','raise-demo-request-content?moduleId='+moduleId+'&requestRaisedBy=student&campaighn=admin&demotype=pool&clickFrom=list');
	}else if(pageNo=='accept-demo-list'){
		callForDashboardData('formIdIfAny','raise-demo-request-content?moduleId='+moduleId+'&requestRaisedBy=student&campaighn=admin&demotype=accept&clickFrom=list');
	}else if(pageNo=='meet-counselor'){
		callForDashboardData('formIdIfAny','raise-demo-request-content?moduleId='+moduleId+'&requestRaisedBy=student&campaighn=counselor&clickFrom=list');
	}else if(pageNo=='ppc-school'){
		callForDashboardData('formIdIfAny','raise-demo-request-content?moduleId='+moduleId+'&requestRaisedBy=school&clickFrom=list');
	}else if(pageNo=='student-meet-slot'){
		callForDashboardData('formIdIfAny','demo-request-meeting-content?moduleId='+moduleId+'&requestType=REQUESTDEMO');
	}else if(pageNo=='counselor-meet-slot'){
		callForDashboardData('formIdIfAny','demo-request-meeting-content?moduleId='+moduleId+'&requestType=COUNSELORMEET');
	}else if(pageNo=='ppc-student'){
		callForDashboardData('formIdIfAny','ppc-request-content?moduleId='+moduleId);
	}else if(pageNo=='lms-student-performance'){
		callForDashboardData('formIdIfAny','lms-student-mail?moduleId='+moduleId);
	}else if(pageNo=='student-weekly-progress'){
		callForDashboardData('formIdIfAny','student-weekly-progress-report?moduleId='+moduleId);
	}else if(pageNo=='accelerated-mode'){
		callForDashboardData('formIdIfAny','accelerated-mode-students-details?moduleId='+moduleId);
	}
//this condition will be evaluate when Admin click on Tips for Educator Ref: IS-191
	else if(pageNo=='tips-educators'){
		callForDashboardData('formIdIfAny','tips-for-educator?moduleId='+moduleId);
	}else if(pageNo=='manage-educational-counselor'){
		callForDashboardData('formIdIfAny','manage-counselor-content?moduleId='+moduleId);
	}else if(pageNo=='add-counselor'){
		callForDashboardData('formIdIfAny','add-counseler-content'+extraParam, replaceDiv);
		...
		callForDashboardData('formIdIfAny','get-module-rights?moduleId='+moduleId);
	}else if(pageNo=='manage-user-list'){
		callForDashboardData('formIdIfAny','manage-profile-content?moduleId='+moduleId+'&profileFor=common&userClickFrom=list&registrationType=ONE_TO_ONE');
	}else if(pageNo=='date-visit-request'){
		callForDashboardData('formIdIfAny','school-date-of-visit-content?moduleId='+moduleId+'&visitSubmitted='+extraParam);
	}else if(pageNo=='edit-subject'){
		callForDashboardData('formIdIfAny','edit-subject-content'+extraParam,replaceDiv);
	}else if(pageNo=='edit-subjectB2C'){
		callForDashboardData('formIdIfAny','edit-subjectB2C-content'+extraParam,replaceDiv);
	}else if(pageNo=='3syllabus'){
		callForDashboardData('formIdIfAny','view-syllabus-content'+extraParam,replaceDiv);
	}else if(pageNo=='3syllabusContent'){
		callForDashboardData('formIdIfAny','current-syllabus-request-content'+extraParam,replaceDiv);
	}else if(pageNo=='batch-schedule'){
		callForDashboardData('formIdIfAny','teacher-batch-time-schedule?moduleId='+moduleId+'&userId='+extraParam);
	}else if(pageNo=='school-diary'){
		callForDashboardData('formIdIfAny','teacher-school-diary?moduleId='+moduleId);
		...
		var urlSend = CONTEXT_PATH+UNIQUEUUID+'/report/school-admission-reports?moduleId='+moduleId+'&schoolId='+SCHOOL_ID+'&countryId=101&sessionId='+SESSION_ID+'&euid='+ENCRYPTED_USER_ID
		window.open(urlSend, '_blank');
		customLoader(false)
		...
		//callForDashboardData('formIdIfAny','lead-list?moduleId='+moduleId+'&leadFrom=LEAD&clickFrom=list&currentPage=0');
		var urlSend = CONTEXT_PATH+UNIQUEUUID+'/dashboard/lead-assign-form?moduleId='+moduleId;
		window.open(urlSend, '_blank');
		customLoader(false)
	}else if(pageNo=='extra-activity'){
		callForDashboardData('formIdIfAny','add-extra-activity?moduleId='+moduleId);
	}else if(pageNo=='view-extra-activity'){
		callForDashboardData('formIdIfAny','user-view-extra-activity'+extraParam);
	...
	//Student - left-side
		...
		callForDashboardData('formIdIfAny','syllabus-assigned-teacher?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','student-due-fees-content?moduleId='+moduleId);
	}else if(pageNo=='user-guide'){
		callForDashboardData('formIdIfAny','user-guide-request-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','student-addons-content?moduleId='+moduleId);
	...
	}else if(pageNo=='student-batch-schedule'){
		callForDashboardData('formIdIfAny','student-batch-time-schedule?moduleId='+moduleId);
	}else if(pageNo=='syllabus-assigned-batch-teacher'){
		callForDashboardData('formIdIfAny','student-batch-teacher-content?moduleId='+moduleId);
	}else if(pageNo=='student-id-card'){
		var urlSend = CONTEXT_PATH+UNIQUEUUID+'/dashboard/student/id-card?download=0&userId='+extraParam;
		window.open(urlSend, '_blank');
		customLoader(false)
	}else if(pageNo=='school-announce'){
		callForDashboardData('formIdIfAny','teacher-school-announce?moduleId='+moduleId);
		...
		var urlSend = CONTEXT_PATH+UNIQUEUUID+'/dashboard/get-student-attendance?moduleId='+moduleId;
		window.open(urlSend, '_blank');
		customLoader(false)
	}else if(pageNo=='batch-attendance'){
		callForDashboardData('formIdIfAny','get-student-attendance?moduleId='+moduleId);
	}else if(pageNo=='bulk-transcript-print'){
		callForDashboardData('formIdIfAny','bulk-transcript-print?moduleId='+moduleId);
		...
		// callForDashboardData('formIdIfAny','student-lms?moduleId='+moduleId);
		getContent(moduleId, pageNo, replaceDiv, extraParam);
	...
	//Teacher
		...
		callForDashboardData('formIdIfAny','teacher-subject-content?moduleId='+moduleId);
	}else if(pageNo=='assigned-student'){
		callForDashboardData('formIdIfAny','assigned-students-content?moduleId='+moduleId);
	}else if(pageNo=='assigned-batch-student'){
		callForDashboardData('formIdIfAny','assigned-batch-students-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','student-attendance-list?moduleId='+moduleId);
	}else if(pageNo=='teacher-training'){
		callForDashboardData('formIdIfAny','techer-user-guide-request-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','teacher-view-tips-attachement'+extraParam);
	}else if(pageNo=='teacher-login-details'){
		callForDashboardData('formIdIfAny','attendance-content'+extraParam);
	}else if(pageNo=='assign-home-work'){
		callForDashboardData('formIdIfAny','teacher-current-task-request-content?moduleId='+moduleId);
		...
		callForDashboardData('formIdIfAny','student-task-subject-content?moduleId='+moduleId);
	}else if(pageNo=='manage-attendance'){
		//callForDashboardData('formIdIfAny','get-student-attendance?moduleId='+moduleId);
		var urlSend = CONTEXT_PATH+UNIQUEUUID+'/dashboard/get-student-attendance?moduleId='+moduleId;
		window.open(urlSend, '_blank');
	...
	//Counselor
		...
		callForDashboardData('formIdIfAny','counselor-content?moduleId='+moduleId);
	}else if(pageNo=='COUNS1a'){
		callForDashboardData('formIdIfAny','counselor-manage-student-content'+extraParam);
	}else if(pageNo=='COUNS1b'){
		callForDashboardData('formIdIfAny','counselor-manage-referral-content'+extraParam);
	}else if(pageNo=='2002'){
		callForDashboardData('formIdIfAny','notifications'+args);
	}
	...
	//Auditors
		...
		callForDashboardData('formIdIfAny','previous-submitted-reports-content?moduleId='+moduleId);
	}else if(pageNo=='auditor-previous-report'){
		callForDashboardData('formIdIfAny','previous-submitted-reports-content?moduleId='+moduleId);
	}else if(pageNo=='auditor-pending-report'){
		callForDashboardData('formIdIfAny','pending-reports-content?moduleId='+moduleId);
	...
	if($('#dashboardContentInHTML .check-activity-page-load').length > 0){
...
//	}else
	if(actionType=='3set'){
		callForDashboardData('formIdIfAny','question-answer-set-content?setId='+arg0);
	}else if(actionType=='1admin'){
		callForDashboardData('formIdIfAny','edit-profile-content?userId='+arg0+'&moduleId='+roleModuleId);
		...
		callForDashboardData('formIdIfAny','school-student-transcript-content?userId='+arg0);
	}else if(actionType=='17a'){
		$('#userPaymentHistoryDetails').show();
		callForDashboardData('formIdIfAny','payment-history-content?userId='+arg0+'&moduleId='+roleModuleId,'userPaymentHistoryDetails');
	}else if(actionType=='19a'){
		callForDashboardData('formIdIfAny','delete-user-content?emailId='+arg0);
		setTimeout(function(){ callDashboardPageSchool(roleModuleId, 'delete-user'); }, 1000);
	}else if(actionType=='18a1'){
		callForDashboardData('formIdIfAny','school-enabled-date-content?'+arg0,replaceDiv);
	}else if(actionType=='6f1'){
		callForDashboardData('formIdIfAny','travel-details-content?userId='+arg0,replaceDiv);
	}else if(actionType=='6fv'){
		callForDashboardData('formIdIfAny','travel-details-content-view?userId='+arg0,replaceDiv);
	}else if(actionType=='6f2'){
		callForDashboardData('formIdIfAny','RM-details-content?userId='+arg0,replaceDiv);
	}else if(actionType=='6fview'){
		callForDashboardData('formIdIfAny','RM-details-content-view?userId='+arg0,replaceDiv);
	}else if(actionType=='7a'){
		callForDashboardData('formIdIfAny','add-student-content'+arg0,replaceDiv);
	}else if(actionType=='22a'){
		callForDashboardData('formIdIfAny','getApprovalSubjectsBySchoolId-content?schoolId='+arg0,replaceDiv);
	}else if(actionType=='22b'){
		callForDashboardData('formIdIfAny','getApprovalPreSubjectsBySchoolId-content?schoolId='+arg0,replaceDiv);
	}else if(actionType=='schoolStudentList'){
		callForDashboardData('formIdIfAny','search-school-student-list'+arg0,replaceDiv);
	}else if(actionType=='addRm'){
		callForDashboardData('formIdIfAny','edit-RM?rmId=',replaceDiv);
	}else if(actionType=='21a11'){
		callForDashboardData('formIdIfAny','choose-school-content?schoolId='+arg0,replaceDiv);
	}else if(actionType=='historyRemarks'){
		callForDashboardData('formIdIfAny','remarks-history-content'+arg0,replaceDiv);
	}else if(actionType=='edit-courseDetails'){
		callForDashboardData('formIdIfAny','edit-course-content'+arg0,replaceDiv);
	}else if(actionType=='edit-placementCourseDetails'){
		callForDashboardData('formIdIfAny','edit-placement-course-content'+arg0,replaceDiv);
	}else if(actionType=='edit-placementSubjectB2C'){
		callForDashboardData('formIdIfAny','edit-placementSubjectB2C'+arg0,replaceDiv);
	}else if(actionType=='placement-syllabus'){
		callForDashboardData('formIdIfAny','view-placement-syllabus-content?subjectId='+arg0);
	}else if(actionType=='teacher-agreement'){
		callForDashboardData('formIdIfAny','view-teacher-agreement-content'+arg0,replaceDiv);
	}else if(actionType=='show-school-receipt'){
		callForDashboardData('formIdIfAny','show-school-receipt-content?userPaymentDetailsId='+arg0,replaceDiv);
		...
		callForDashboardData('formIdIfAny','edit-teacher-compensation'+arg0,replaceDiv);
		...
		callForDashboardData('formIdIfAny','profile-view-content?userId='+arg0+'&actionType='+actionType+'-'+cuserId+'&moduleId='+roleModuleId);
	}else if(actionType=='3syllabus'){
		callForDashboardData('formIdIfAny','student-syllabus-content?subjectId='+arg0+'&moduleId='+roleModuleId);
	}else if(actionType=='3classWork'){
		callForDashboardData('formIdIfAny','student-task-request-content?subjectId='+arg0);
		...
		callForDashboardData('formIdIfAny','student-addons-subject-content?subjectId='+arg0+'&moduleId='+roleModuleId);
		//callForDashboardData('formIdIfAny','student-addons-subject-content?subjectId='+arg0+'&moduleId='+roleModuleId, 'subject-plan');
	}else if(actionType=='1a'){
		callForDashboardData('formIdIfAny','profile-view-content?userId='+arg0+'&actionType='+actionType+'&moduleId='+roleModuleId);
	}else if(actionType=='attendance'){
		callForDashboardData('formIdIfAny','attendance-content'+arg0);
	}
//	else if(actionType=='addonpayment'){
//		callForDashboardData('formIdIfAny','student-addons-subject-content?subjectId='+arg0+'&moduleId='+roleModuleId);
////		callForDashboardData('formIdIfAny','student-addons-subject-content?subjectId='+arg0, 'subject-plan');
//	}
	else if(actionType=='subjectsession'){
		callForDashboardData('formIdIfAny','student-subject-session?subjectId='+arg0+'&moduleId='+roleModuleId);
	}
	//teacher
	else if(actionType=='teacher-3syllabus'){
		callForDashboardData('formIdIfAny','teacher-syllabus-content'+arg0+'&moduleId='+roleModuleId);
	}
	//parent
	if(actionType=='parent-3syllabus'){
		...
		callForDashboardData('formIdIfAny','request-demo-edit-form?requestId='+arg0+'&actionType='+actionType+'&moduleId='+roleModuleId);
	}else if(actionType=='student-task'){
		callForDashboardData('formIdIfAny','student-task-data-content'+arg0+'&moduleId='+roleModuleId);
	}else if(actionType=='student-lms'){
		// callForDashboardData('formIdIfAny','student-lms'+arg0+'&moduleId='+roleModuleId);
		getContent(moduleId, pageNo, replaceDiv, extraParam);
	}
}
...
function submitTeacherQuestion(formId,moduleId) {
		...
		$.ajax({
			...
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					$('#'+formId)[0].reset();
					setTimeout(function(){ callDashboardPageSchool(0,'14'); }, 1000);
				}
				return false;
			},
			error : function(e) {
	...
	function getRequestForSubmitSet(formId,moduleId){
		...
		questionSetDTO['setNameId'] = $("#"+formId+" #setName option:selected").val();
		questionSetDTO['setTitle'] = $("#"+formId+" #setTitle").val();
		questionSetDTO['status'] = "1";
		questionSetDTO['videoUrl'] = $("#"+formId+" #videoUrl").val();
		questionSetDTO['gradeName'] = $("#"+formId+" #standardId option:selected").val();
		questionSetDTO['subjectName'] = $("#"+formId+" #subjectId option:selected").val();
	...
	function validateRequestForSubmitSet(formId,moduleId){
		if($('#setName').val()==undefined || $('#setName').val()=='' ||  $('#setName').val()==0){
		...
		if($('#standardId').val()==undefined || $('#standardId').val()=='' ||  $('#standardId').val()==0){
			showMessage(true, 'Standard is required.');
			return false;
		}
		if($('#subjectId').val()==undefined || $('#subjectId').val()=='' ||  $('#subjectId').val()==0){
	...
	function getRequestForSubmitQuestion(formId,moduleId){
		...
		questionAnswerDTO['correctAnswer'] = $("#"+formId+" #correctAns option:selected").val();
	...
	function submitScholarship(formId,moduleId,modalId,isForSpecificUser, controlType, scholarId, roleModuleId,schoolId) {
		hideMessage('');
		if("add"==controlType){
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSubmitScholarship(formId, moduleId,isForSpecificUser, controlType, scholarId,schoolId)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
	...
	function getRequestForSubmitScholarship(formId,moduleId,isForSpecificUser, controlType, scholarId,schoolId){
		var request = {};
		var authentication = {};
		var requestData = {};
		...
		if("add"==controlType){
			...
			if($("#"+formId+" #scholarMadeFor option:selected").text()=='Full-Time Program'){
				scholarShipCodeDTO['scholarMadeFor'] = 'Signup for Full-Time/Flex Program';
			}else{
	...
	function validateRequestForSubmitScholarship(formId,moduleId,modalId){
		...
		if ($("#"+formId+" #scholarCode").val()==0 || $("#"+formId+" #scholarCode").val()==null) {
			showMessage(true, 'Scholarship code is required');
			return false
		}
		if ($("#"+formId+" #scholarMadeFor").val()==undefined || $("#"+formId+" #scholarMadeFor").val()=="") {
			showMessage(true, 'Please fill Scholarship/Discount Code for');
			return false
		}
		if ($("#"+formId+" #scholarApplicableFor").val()==undefined || $("#"+formId+" #scholarApplicableFor").val()=="") {
			showMessage(true, 'Applicability of Scholarship/Discount Code is required.');
			return false
		}
		if ($("#"+formId+" #scholarStartDate").val()=='' || $("#"+formId+" #scholarStartDate").val()==null) {
			showMessage(true, 'Scholarship Start Date is required');
			return false
		}
		if ($("#"+formId+" #scholarEndDate").val()=='' || $("#"+formId+" #scholarEndDate").val()==null) {
		...
		if (endDate < startDate){
			showMessage(false, 'Scholarship End Date should be greater than Scholarship Start Date.');
			return false
			}
		if ($("#"+formId+" #scholarType").val()==0 || $("#"+formId+" #scholarType").val()==null) {
			showMessage(true, 'Scholarship discount type is required');
			return false
		}
		if ($("#"+formId+" #scholarPercent").val()==0 || $("#"+formId+" #scholarPercent").val()==null) {
...
//		$("#"+modalId).modal('toggle');
	...
	function sendToSpecificUser(formId,moduleId,isForSpecificUser, roleModuleId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSpecificUserScholarship(formId, moduleId,isForSpecificUser)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
	...
	function getRequestForSpecificUserScholarship(formId,moduleId,isForSpecificUser){
		var request = {};
		var authentication = {};
		var requestData = {};
		var scholarShipCodeDTO = {};
		scholarShipCodeDTO['scholarId'] = $("#"+formId+" #scholarCode").val();
		scholarShipCodeDTO['scholarCodeName'] = $("#"+formId+" #scholarCode option:selected").text();
		scholarShipCodeDTO['userEmailId'] = $("#"+formId+" #userEmailId").val();
		scholarShipCodeDTO['isForSpecificUser'] = isForSpecificUser;
		scholarShipCodeDTO['scholarshipApplicableFor'] = $("#"+formId+" #scholarshipApplicableFor").val();
...
//		var todayDate = new Date();
		if ($("#"+formId+" #meetingDate").val()==null || $("#"+formId+" #meetingDate").val()=="") {
			showMessage(true, 'Please select Meeting Date');
			return false
		}
		if ($("#"+formId+" #startTime").val()==null || $("#"+formId+" #startTime").val()=="") {
			showMessage(true, 'Please select Start Time');
			return false
		}
		if ($("#"+formId+" #timeInterval").val()==null || $("#"+formId+" #timeInterval").val()==0) {
	...
	function submitMeetingSlots(formId,moduleId, roleModuleId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSubmitMeetingTeacherSlots(formId, moduleId)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId, 'teacher-interview-slot'); }, 1000);
	...
	function validateRequestDemoMeetingSlots(formId,moduleId,controllType,requestType){
		if("ADD"==controllType){
		var meetDate = $("#"+formId+" #meetingDate").val();
		meetDate = meetDate.split("-");
		meetingDate = meetDate[2]+"-"+meetDate[0]+"-"+meetDate[1];
	...
	function submitRequestDemoMeetingSlots(formId,moduleId,controllType, meetingId,requestType, roleModuleId) {
		hideMessage('');
		...
		$.ajax({
			...
			contentType : "application/json",
			url : getURLFor('dashboard','meetingslots-submit'),
			data : JSON.stringify(getRequestForSubmitRequestDemoMeetingSlots(formId, moduleId,controllType, meetingId,requestType)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
	...
	function getRequestForSubmitRequestDemoMeetingSlots(formId,moduleId, controllType,meetingId,requestType){
		var request = {};
		var authentication = {};
		var requestData = {};
		var meetingSlotDTO = {};
		...
		authentication['hash'] = getHash();authentication['schoolId'] = SCHOOL_ID;authentication['schoolUUID'] = SCHOOL_UUID;
		authentication['userType'] = moduleId;
		authentication['userId'] = $("#teacherMeetingSlotsForm #userId").val();
		request['authentication'] = authentication;
		request['requestData'] = requestData;
		return request;
	}
	...
	function getRequestForSubmitSyllabus(formId,moduleId){
		...
		syllabusDTO['courseProviderId']=$("#"+formId+" #courseProviderId").val();
	...
	function submitTeacherAgreement(formId,moduleId, roleModuleId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSubmitTeacherAgreement(formId, moduleId)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
	...
	function getRequestForSubmitTeacherAgreement(formId,moduleId){
		var request = {};
		var authentication = {};
		var requestData = {};
		...
		teacherAgreementDTO['agreementRefNumber']=escapeCharacters($("#"+formId+" #agreementRefNumber").val());
		teacherAgreementDTO['agreementDate']=$("#"+formId+" #agreementDate").val();
		teacherAgreementDTO['interviewId']=$("#"+formId+" #meetingId").val();
		teacherAgreementDTO['remarksInterview']=escapeCharacters($("#"+formId+" #remarksInterview").val());
	...
	function submitPlacementSyllabus(formId,moduleId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSubmitPlacementSyllabus(formId, moduleId)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					showMessage(false, data['message']);
					$('#'+formId)[0].reset();
					setTimeout(function(){ callDashboardPageSchool('32'); }, 1000);
				}
				return false;
			},
			error : function(e) {
	...
	function getRequestForSubmitSlot(formId,moduleId){
		...
		enabledDateDTO['timeZoneId'] = $("#"+formId+" #countryTimezoneId option:selected").val();
		...
		$.ajax({
			...
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'manage-lms-user'); }, 1000);
				}
	...
	function getRequestForLMSUserSignup(formId, moduleId){
		...
		lmsUserInfoDTO['lmsUserName'] =escapeCharacters( $("#"+formId+" #lmsUserName").val());
		lmsUserInfoDTO['password'] = $("#"+formId+" #password").val();
		lmsUserInfoDTO['confirmPassword'] = $("#"+formId+" #confirmPassword").val();
...
//			        console.log('emailList main: '+emailList);
	...
	function approveSubject(formId,moduleId,isApproved,subjectId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForApproveSubject(formId, moduleId,isApproved,subjectId)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
...
function saveCourse(formId,moduleId,courseId,controlType, roleModuleId) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSaveCourse(formId, moduleId,courseId,controlType)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'manage-categories'); }, 1000);
				}
				return false;
			},
			error : function(e) {
...
function getRequestForSaveCourse(formId,moduleId,courseId,controlType){
		...
		var requestData = {};
		var courseInfoDTO = {};
		if(controlType=='delete' || controlType=='active' || controlType=='inactive'){
			courseInfoDTO['isForDelete']='Y';
			courseInfoDTO['courseId']=courseId;
		}else if(controlType=='add' || controlType=='edit'){
			courseInfoDTO['courseProviderId']=$("#"+formId+" #courseProvider").val();
...
function validateRequestForAddCourse(formId,controlType){
	...
	if(controlType=="" && controlType != 'add'  && controlType != 'edit' && controlType != 'delete'){
		showMessage(true,"Invalid control type.");
		return false;
	}
	if(controlType=='delete'){}else{

		if($("#"+formId+" #standardId").val()==0  && controlType != 'delete'){
			showMessage(true,"Please choose grade.");
			return false
		}
		if($("#"+formId+" #courseName").val()==""  && controlType != 'delete'){
...
function savePlacementCourse(formId,moduleId,courseId,isForDelete) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSavePlacementCourse(formId, moduleId,courseId,isForDelete)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					showMessage(true, data['message']);
					$('#courseInfoModal').modal('hide');
					setTimeout(function(){ return callDashboardPageSchool('30'); }, 1000);
				}
				return false;
			},
			error : function(e) {
...
function getRequestForSavePlacementCourse(formId,moduleId,courseId,isForDelete){
		console.log('getRequestForSaveCourse');
		var request = {};
		var authentication = {};
		var requestData = {};
...
function validateRequestForAddPlacementCourse(formId,isForDelete){
	...
	if($("#"+formId+" #standardId").val()==0 ||$("#"+formId+" #standardId").val()==undefined && isForDelete!='Y'){
		showMessage(true,"Please choose grade.");
		return false;
	}
	...
	function saveSubjectB2C(formId,moduleId,subjectId,isForDelete, roleModuleId) {
		hideMessage('');
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForSaveSubjectB2C(formId, moduleId,subjectId,isForDelete)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'manage-courses'); }, 1000);
				}
				return false;
			},
			error : function(e) {
	...
	function getRequestForSaveSubjectB2C(formId,moduleId,subjectId,isForDelete){
		...
		subjectListB2CInfoDTO['courseProviderId'] = $("#"+formId+" #courseProvider").val();
		...
		subjectListB2CInfoDTO['subjectName']=$("#"+formId+" #subjectName").val();
		subjectListB2CInfoDTO['subjectCode']=$("#"+formId+" #subjectCode").val();
		subjectListB2CInfoDTO['lmsCourseId']=$("#"+formId+" #lmsCourseId").val();
		subjectListB2CInfoDTO['parentId']=$("#"+formId+" #parentId").val();
		subjectListB2CInfoDTO['selfPid']=$("#"+formId+" #selfPid").val();
		subjectListB2CInfoDTO['subjectHint']=$("#"+formId+" #subjectHint").val();
		subjectListB2CInfoDTO['isCompulsory']=$("#"+formId+" #isCompulsory").val();
		subjectListB2CInfoDTO['duration']=$("#"+formId+" #duration").val();
		subjectListB2CInfoDTO['costAnnual']=$("#"+formId+" #costAnnual").val();
		subjectListB2CInfoDTO['costThreeMonth']=$("#"+formId+" #costThreeMonth").val();
		subjectListB2CInfoDTO['costSixMonth']=$("#"+formId+" #costSixMonth").val();
		subjectListB2CInfoDTO['costNineMonth']=$("#"+formId+" #costNineMonth").val();
		subjectListB2CInfoDTO['subjectIcon']=$("#"+formId+" #subjectIcon").val();
		...
		if(editor4!=undefined){
			subjectListB2CInfoDTO['materialRequired']=escapeCharacters(editor4.getData());
		}
	...
	function savePlacementSubjectB2C(formId,moduleId,subjectId,isForDelete) {
		...
		$.ajax({
			...
			data : JSON.stringify(getRequestForPlacementSaveSubjectB2C(formId, moduleId,subjectId,isForDelete)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool('31'); }, 1000);
				}
				return false;
			},
			error : function(e) {
	...
	function getRequestForPlacementSaveSubjectB2C(formId,moduleId,subjectId,isForDelete){
		...
		placementSubjectListB2CInfoDTO['subjectId']=$("#"+formId+" #subjectId").val();
		placementSubjectListB2CInfoDTO['standardId']=$("#"+formId+" #standardId").val();
		placementSubjectListB2CInfoDTO['courseId']=$("#"+formId+" #courseId").val();
		placementSubjectListB2CInfoDTO['subjectName']=$("#"+formId+" #subjectName").val();
		placementSubjectListB2CInfoDTO['subjectCode']=$("#"+formId+" #subjectCode").val();
		placementSubjectListB2CInfoDTO['placementCourseId']=$("#"+formId+" #placementCourseId").val();
		placementSubjectListB2CInfoDTO['parentId']=$("#"+formId+" #parentId").val();
		placementSubjectListB2CInfoDTO['selfPid']=$("#"+formId+" #selfPid").val();
		placementSubjectListB2CInfoDTO['subjectHint']=$("#"+formId+" #subjectHint").val();
		placementSubjectListB2CInfoDTO['isCompulsory']=$("#"+formId+" #isCompulsory").val();
		placementSubjectListB2CInfoDTO['duration']=$("#"+formId+" #duration").val();
		placementSubjectListB2CInfoDTO['costAnnual']=$("#"+formId+" #costAnnual").val();
		placementSubjectListB2CInfoDTO['costThreeMonth']=$("#"+formId+" #costThreeMonth").val();
		placementSubjectListB2CInfoDTO['costSixMonth']=$("#"+formId+" #costSixMonth").val();
		placementSubjectListB2CInfoDTO['costNineMonth']=$("#"+formId+" #costNineMonth").val();
		placementSubjectListB2CInfoDTO['subjectIcon']=$("#"+formId+" #subjectIcon").val();
		...
		if(editor1!=undefined){
			placementSubjectListB2CInfoDTO['requirement']=escapeCharacters(editor1.getData());
		}
		if(editor2!=undefined){
			placementSubjectListB2CInfoDTO['optional']=escapeCharacters(editor2.getData());
		}
		if(editor3!=undefined){
			placementSubjectListB2CInfoDTO['additional']=escapeCharacters(editor3.getData());
		}
		if(editor4!=undefined){
			placementSubjectListB2CInfoDTO['materialRequired']=escapeCharacters(editor4.getData());
		}

		requestData['placementSubjectListB2CInfoDTO'] = placementSubjectListB2CInfoDTO;
		authentication['hash'] = getHash();authentication['schoolId'] = SCHOOL_ID;authentication['schoolUUID'] = SCHOOL_UUID;
		authentication['userType'] = moduleId;
		authentication['userId'] = $("#userId").val();
		request['authentication'] = authentication;
...
function callCourseListBySubjectId(formId, value, elementId, toElementId, requestExtra, requestExtra1) {
		hideMessage('');
		...
		$.ajax({
			...
			contentType : "application/json",
			url : getURLForCommon('masters'),
			data : JSON.stringify(getRequestForMaster(formId, 'COURSE-LIST-BY-STANDARD-ID', value, requestExtra, requestExtra1)),
			dataType : 'json',
			cache : false,
			timeout : 600000,
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					$.each(result, function(k, v) {
							dropdown.append('<option value="' + v.key + '" parentid="'+v.extra+'">' + v.value + '</option>');
					});
...
function callPlacementCourseListByStandardId(formId, value, elementId, toElementId, requestExtra) {
	hideMessage('');
	...
	$.ajax({
		...
		contentType : "application/json",
		url : getURLForCommon('masters'),
		data : JSON.stringify(getRequestForMaster(formId, 'PLACEMENT-COURSE-LIST-BY-STANDARD-ID', value, requestExtra)),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		success : function(data) {
 ...
 function sendEmailForCommon(userId,controlType){
		...
		$.ajax({
			...
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'request-demo','','?requestRaisedBy=student&campaighn=admin'); }, 1000);
				}
		...
		$.ajax({
			...
			success : function(data) {
				if (data['status'] == '0' || data['status'] == '2') {
					...
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'lms-student-performance'); }, 1000);
				}
				return false;
			},
			error : function(e) {
	...
	function validateRequestForLMSStudentPerformance(){
		...
		if ($("#subjectEventId").val() == 'CR'|| $("#subjectEventId").val() == 'FT') {
	...
	function getRequestForLMSStudentPerformance(formId, moduleId){
		...
		lmsStudentPerformanceTrackDTO['studentName'] = $("#"+formId+" #studentName").val();
		lmsStudentPerformanceTrackDTO['studentEmail'] = $("#"+formId+" #studentEmail").val();
		lmsStudentPerformanceTrackDTO['teacherName'] = $("#"+formId+" #teacherName").val();
		lmsStudentPerformanceTrackDTO['teacherEmail'] = $("#"+formId+" #teacherEmail").val();
		lmsStudentPerformanceTrackDTO['courseProviderId'] = $("#"+formId+" #courseProvider").val();
		lmsStudentPerformanceTrackDTO['comments'] = $("#"+formId+" #idComments").val();
		if($("#standardId").val()!=0 && $("#standardId").val()!=null){
		...
		if($("#placementStandardId").val()!=0 && $("#placementStandardId").val()!=null){
			lmsStudentPerformanceTrackDTO['placementStandardId'] = $("#placementStandardId").val();
		}
		if($("#placementSubjectId").val()!=0 && $("#placementSubjectId").val()!=null){
			lmsStudentPerformanceTrackDTO['placementSubjectId'] = $("#placementSubjectId").val();
		}
...
//		hideMessage('');
		$.ajax({
			...
			data : "scholarId="+scholarId+"&scholarCode="+scholarCode,
			dataType : 'html',
			cache : false,
			timeout : 600000,
			success : function(htmlContent) {
...
function getCourseByGradeAndCourseId(formId) {
	...
	$.ajax({
		type : "GET",
		contentType : "application/json",
		url : getURLFor('school','get-course-by-grade-and-course-id/'+gradeId+'/'+courseId),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		success : function(data) {
			...
			if (data['status'] == '0' || data['status'] == '2') {
				...
				$("#"+formId+" #selfPid").html('')
				$("#"+formId+" #parentId").html('<option value="0"> Self </option>')
				$("#"+formId+" #selfPid").html('<option value="0"> Self </option>')
				$("#"+formId+" #selfPid").append('<option value="1"> None </option>')
				$.each(data.courseByGradeAndCourseIdList, function(k, v) {
					$("#"+formId+" #parentId").append('<option value="' + v.subjectId + '">' + v.subjectCode + ' - ' + v.subjectName + '</option>');
					$("#"+formId+" #selfPid").append('<option value="' + v.subjectId + '">' + v.subjectCode + ' - ' + v.subjectName + '</option>');
				});
			}
			return false;
		},
...
function callCommentModel(meetingId, meetingResult, requestDemoId, comment,leadId,currentPageNo){
...
function sendMailForMeetCounselor(formId,roleModuleId, callFrom){
	...
	if($("#"+formId+" #comment").val()==undefined || $("#"+formId+" #comment").val()==''){
	...
	$.ajax({
		...
		data : JSON.stringify(getRequestForsendMailForMeetCounselor(formId,callFrom)),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		success : function(data) {
			if (data['status'] == '0' || data['status'] == '2') {
				...
				if("lead"==callFrom){
					var currentPageNo =0;
					if($("#"+formId+" #currentPageNo").val()!=null &&  $("#"+formId+" #currentPageNo").val()!=''){
						currentPageNo = $("#"+formId+" #currentPageNo").val();
					}
					setTimeout(function(){ advanceLeadSearchStudent('advanceLeadNewSearchForm',roleModuleId, 'LEAD','list' ,currentPageNo,'new', true);}, 1000);
				}else{
					setTimeout(function(){ callDashboardPageSchool(roleModuleId,'request-demo'); }, 1000);
				}
			}
			return false;
		},
...
function getRequestForsendMailForMeetCounselor(formId,callFrom){
	...
	meetCounselorMailDTO['requestDemoId']=$("#"+formId+" #requestDemoId").val();
	meetCounselorMailDTO['comment'] = escapeCharacters($("#"+formId+" #comment").val());
	meetCounselorMailDTO['meetingResult'] = $("#"+formId+" #meetingResult").val();
...
function saveCourseProvider(formId,controllType, providerId, status,roleModuleId){

	$.ajax({
		type : "POST",
		contentType : "application/json",
		url : getURLFor('school','save-courseProvider-details'),
		data : JSON.stringify(getRequestForSaveCourseProvider(formId, controllType, providerId, status)),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		success : function(data) {
			if (data['status'] == '0' || data['status'] == '2') {
				...
				showMessage(true, data['message']);
				setTimeout(function(){ callDashboardPageSchool(roleModuleId,'manage-course-provider'); }, 1000);
			}
			return false;
		},
		error : function(e) {
...
function getRequestForSaveCourseProvider(formId,controllType, providerId, status){
	var request = {};
	var authentication = {};
	var requestData = {};
	...
	$.ajax({
		...
		success : function(data) {
			if (data['status'] == '0' || data['status'] == '2') {
				...
				$('.modal-backdrop').remove();
				$('body').removeClass('modal-open');
				setTimeout(function(){callDashboardPageSchool(roleModuleId,'module');},1000);
			}
			return false;
		},
		error : function(e) {
...
function validateRequestForNewModule(formId,moduleId){
	if($('#'+formId+' #moduleName').val()==0 || $('#'+formId+' #moduleName').val()==''){
	...
	if($('#'+formId+' #moduleType').val()==0 || $('#'+formId+' #moduleType').val()==''){
		showMessage(true, 'Module type is required.');
		return false;
	}

	if($('#'+formId+' #moduleType').val()=='M'){
		if($('#'+formId+' #moduleIcon').val()==0 || $('#'+formId+' #moduleIcon').val()==''){
...
//	}
	...
	if($('#'+formId+' #moduleActive').val()==undefined || $('#'+formId+' #moduleActive')==''){
...
function validateRequestForNewRole(formId,moduleId){
	if($('#'+formId+' #roleName').val()==0 || $('#'+formId+' #roleName').val()==''){
...
//	}
	...
	if($('#'+formId+' #roleActive').val()==undefined || $('#'+formId+' #roleActive')==''){
...
function callModuleRights(formId, roleId, divId) {
	...
	$.ajax({
		...
		data : "request="+JSON.stringify(getRequestForModuleRights(formId, roleId)),
		dataType : 'html',
		cache : false,
		timeout : 600000,
		success : function(data) {
		...
		if(chkId.length>0){
			if(chkId[0]=='moduleId'){
				...
				if($("#moduleId_"+chkId[1]).is(":checked")){
					...
					roleRights['moduleType'] = $("#moduleId_"+chkId[1]).attr("data-moduletype");
				}else{
				...
				if($("#moduleAddId_"+chkId[1]).is(":checked")){
					...
					roleRights['moduleType'] = $("#moduleAddId_"+chkId[1]).attr("data-moduletype");
				}else{
				...
				if($("#moduleUpdateId_"+chkId[1]).is(":checked")){
					...
					roleRights['moduleType'] = $("#moduleUpdateId_"+chkId[1]).attr("data-moduletype");
				}else{
				...
				if($("#moduleViewId_"+chkId[1]).is(":checked")){
					...
					roleRights['moduleType'] = $("#moduleViewId_"+chkId[1]).attr("data-moduletype");
				}else{
				...
				if($("#moduleDeleteId_"+chkId[1]).is(":checked")){
					...
					roleRights['moduleType'] = $("#moduleDeleteId_"+chkId[1]).attr("data-moduletype");
				}else{
		...
		success : function(data) {
			if (data['status'] == '0' || data['status'] == '2') {
				...
				if(data['status'] == '1'){
					...
					setTimeout(function (){callDashboardPageSchool(moduleId,'user-list');},1000);
				}
			}
			return false;
		},
...
function getRequestForNewUser(formId, moduleId){
	...
	signupStudentDTO['roleUser'] = $("#"+formId+" #roleUser option:selected").text();
	...
	signupStudentDTO['password'] = escapeCharacters($("#"+formId+" #password").val());
		...
		$.ajax({
			...
			success : function(data) {
				...
				if("teacherPage"==callFrom){
					setTimeout(function (){callDashboardPageSchool(moduleId,'approved-teachers');},1000);
				}else{
					setTimeout(function (){callDashboardPageSchool(moduleId,'user-list');},1000);
				}
			},
...
function showTeacherStatusPopup(message, status,gotoId, userId, meetingVendor){
	...
	if(status=="Active"){
		...
		$("#resetDeleteErrorWarningNo").text("Deactivate").addClass('btn-primary').removeClass('btn-danger,btn-success');
...
function callStudntTask(taskId,userId,moduleId) {
	hideMessage('');
	$.ajax({
		type : "POST",
		url : getURLForHTML('dashboard','task-homework-student/'+SCHOOL_UUID),
		data : "taskId="+taskId+"&userId="+userId+"&moduleId="+moduleId,
		dataType : 'html',
		cache : false,
		timeout : 600000,
		success : function(htmlContent) {
			if(htmlContent!=""){
        		...
        		if(stringMessage[0] == "FAILED" || stringMessage[0] == "EXCEPTION" || stringMessage[0] == "SESSIONOUT" ){
        			...
        			$('#taskstudentHomworkContent').html(htmlContent);
        		}
        		return false;
			}
		},
...
function validateStudentTaskHomeWork(formId,moduleId){
	if ($("#"+formId+" #contentReply").val()==null || $("#"+formId+" #contentReply").val()==undefined || $("#"+formId+" #contentReply").val()=='') {
	...
	if (attachmentName1.trim() == "" || attachmentName1.trim() == undefined || attachmentName1.trim() == "No file chosen..." ) {
		showMessageTheme2(0,"Attachment is required.",'',false);
		return false;
	}
	return true;
}

function submitStudentTaskHomeWork(formId,moduleId) {
	hideMessage('');
	if(!validateStudentTaskHomeWork(formId,moduleId)){
		return false;
	}
	$.ajax({
		type : "POST",
		contentType : "application/json",
		url : getURLForHTML('dashboard','student-homework-submit/'+SCHOOL_UUID),
		data : JSON.stringify(getRequestForStudentTaskHomeWork(formId,moduleId)),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		success : function(data) {
...
function getRequestForStudentTaskHomeWork(formId,moduleId){
	var request = {};
	var authentication = {};
	var requestData = {};
	var  taskdto={};
	taskdto['taskId'] = $("#" + formId + " #taskId").val();
	taskdto['replyAttachement'] = $('#fileupload1').parents(".file-tab").find("span.fileName").text();;
	taskdto['contentReply'] = $("#" + formId + " #contentReply").val();
...
function callAllAcademicYear(formId) {
	...
	$.ajax({
		...
		data : JSON.stringify(getRequestForMaster('formId',
				'ALL-ACADEMIC-YEAR-LIST', 'academicYear')),
		dataType : 'json',
		cache : false,
		timeout : 600000,
		async : false,
		success : function(data) {
			if (data['status'] == '0' || data['status'] == '2') {
				...
				$.each(result, function(k, v) {
					dropdown.append('<option value="' + v.key + '">' + v.key+'-'+ v.value
							+ ' </option>');
				});
			}
		},
...
function resetBulkTranscriptSearchFilter(formId) {
	...
	$("#" + formId + " #gradeDropDown").val("0").trigger('change');
...
function printStudentCertificates(formId,moduleId) {
	if($('#'+formId+' #certificateType').val()==0 || $('#'+formId+' #certificateType').val()==undefined ){
		showMessage(true,"Please choose certificate type");
		return false;
	}
	if($('#'+formId+' #certificateType').val()=='AV'){
		if($('#'+formId+' #showSealSignature').val()==0 || $('#'+formId+' #showSealSignature').val()==undefined ){
	...
	var data = "gradeId="+gradeId+"&courseProviderId="+courseProviderId+"&learningProgram="+learningProgram+"&academicYear="+academicYear+"&certificateType="+certificateType+"&batchName="+batchName+"&studentName="+studentName+"&studentEmail="+studentEmail+"&studentRollNumber="+studentRollNumber+"&sortBy="+sortBy+"&startPosition="+startPosition+"&numberOfRecords="+numberOfRecords+"&showSealAndSignature="+showSealAndSignature;
	window.open(window.location.origin+CONTEXT_PATH+UNIQUEUUID+'/dashboard/print-certificates?'+data);
}
